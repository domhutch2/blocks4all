...
| Parameter | Standard |
|---|---|
| **Solution** | Ropivacaine 0.2% + fentanyl 2 mcg/mL |
| **Loading dose** | 5–10 mL bolus, titrated to effect |
| **Infusion rate** | 5–10 mL/hr |
| **Patient bolus** | 3–5 mL, lockout 20–30 min |
| **Duration** | Typically 48–72 hours postoperatively |

### Management

- Assess block height (target: 4 dermatomes above and below incision)
- Monitor: sedation score, respiratory rate, motor block (Bromage scale), blood pressure
