---
sidebar_position: 1
tags: [thyroid, superficial cervical plexus, bilateral]
---
...
- **Deep cervical plexus block** — greater analgesic depth but higher risk (phrenic nerve, vertebral artery)
- **Surgeon-delivered wound infiltration**

## Considerations

- Bilateral block required for midline incisions
- Low-risk technique with significant opioid-sparing benefit
- Useful as part of enhanced recovery — facilitates earlier discharge
- Monitor for signs of bilateral phrenic involvement (rare with superficial approach)
