---
sidebar_position: 1
tags: [hernia, inguinal, TAP, ilioinguinal]
---
...
- **Spinal anaesthesia** — suitable as primary anaesthetic for open repair
- **Surgeon-delivered local infiltration** — complements regional block

## Considerations

- For open repair, ilioinguinal/iliohypogastric block is often sufficient
- For laparoscopic repair, TAP block addresses port site and mesh pain
- Combine with simple oral analgesics for enhanced recovery
